package ua.com.hookahcat.csvsdk.service;

import static org.apache.commons.collections4.CollectionUtils.isNotEmpty;
import static ua.com.hookahcat.csvsdk.common.CsvConstants.ErrorKey.CSV_EXPORT_ERROR;
import static ua.com.hookahcat.csvsdk.common.CsvConstants.ErrorKey.CSV_IMPORT_ERROR;
import static ua.com.hookahcat.csvsdk.common.CsvConstants.ErrorKey.CSV_IMPORT_INVALID_CONTENT;
import static ua.com.hookahcat.csvsdk.common.CsvConstants.ErrorKey.CSV_IMPORT_INVALID_HEADERS;
import static ua.com.hookahcat.csvsdk.common.CsvConstants.ErrorKey.EXPORT_ERROR_REPORT_FAILED;
...
import ua.com.hookahcat.csvsdk.common.EscapeFormulaEncoder;
import ua.com.hookahcat.csvsdk.model.CsvRow;
import ua.com.hookahcat.csvsdk.service.exception.CsvException;
import ua.com.hookahcat.reststarter.exception.BadRequestRestException;
...
public class CsvService {
     ...
     * @param headers        an array of Strings linking the CSV columns to their corresponding
     *                       field in the bean (each element in the processor array corresponds with
     *                       a CSV column - the number of processor should match the number of
     *                       columns). A
     ...
     *                       populated on the bean A <tt>null</tt> indicates no further processing
     *                       is required
     */
    public List readData(
        ...
        try (ICsvBeanReader beanReader = new CsvBeanReader(new StringReader(csvInput),
            ...
            while ((entity = getEntity(beanReader, entityClass, fieldNames, cellProcessors))
                != null) {
    ...
    public byte[] exportData(List entities, List<String> headers, List<String> fields) {
        return exportDataWithPreference(entities, headers, fields,
            CsvPreference.STANDARD_PREFERENCE);
    }
